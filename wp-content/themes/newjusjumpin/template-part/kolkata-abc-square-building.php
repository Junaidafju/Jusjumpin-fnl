<?php
/**
 * Template: Kolkata - ABC Square Building
 * Modern location page with hero slider and glassmorphism design
 */

// Page specific variables
$title = "Kolkata - ABC Square Mall | Jus Jumpin";
$state = "West Bengal";
$city = "Newtown";
$slug = "kolkata-abc-square-building";
$address = "11th Floor, ABC Square, near Decathlon, Action Area IID, Newtown, Kolkata, New Town, West Bengal 700161";
...
<section class="location-hero-slider">
    <div class="hero-slider-wrapper">
        <div class="hero-slide active">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC1.jpg'); ?>" alt="Jus Jumpin Kolkata ABC Square" class="hero-slide-img">
        </div>
    ...
    <div class="hero-slider-content">
        <div class="container">
            <h1 class="location-hero-title">
                ...
                Jus Jumpin<br>ABC Square Building - Kolkata
            </h1>
            <p class="location-hero-subtitle">Dive into the world of pure joy and laughter at Jus Jumpin. With more than 15 thrilling gaming activities for kids, and a large range of delicious food, a memorable day out is guaranteed with us.</p>
        </div>
    </div>
...
<section class="location-section map-section">
    <div class="container">
        <h2 class="section-heading"><span class="emoji-icon"><i class="fas fa-map-marker-alt"></i></span> Location: Jus Jumpin – ABC Square Building</h2>
        
        <div class="address-card glass-card">
            <div class="address-content">
                <p class="address-main"><strong>Address:</strong></p>
                <p>11th Floor, ABC Square, near Decathlon,,<br>
                Action Area II, Action Area IID, Newtown, Kolkata, New Town, West Bengal 700161.<br><strong>Call Us:</strong> (+91)98362 29922</p>
                <p class="landmarks"><strong>Landmarks:</strong> Near Decathlon, NKDA Stadium, and ABC Sqaure Building</p>
            </div>
        </div>
        
        <div class="map-container">
            <iframe
                src="https://maps.google.com/maps?q=abc+square+building&t=&z=12&ie=UTF8&iwloc=&output=embed"
                width="100%"
                height="450"
                ...
                title="Jus Jumpin Kolkata ABC Square Location">
            </iframe>
        </div>
