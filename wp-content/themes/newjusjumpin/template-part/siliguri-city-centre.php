...
<section class="location-hero-slider">
    <div class="hero-slider-wrapper">
        <div class="hero-slide active">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/City-Centre_Siliguri.webp'); ?>" alt="Jus Jumpin Siliguri City Centre" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC2.jpg'); ?>" alt="Adult Trampoline Park Siliguri" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC3.jpg'); ?>" alt="Siliguri City Centre Activities" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC4.jpg'); ?>" alt="Trampoline Park Fun Siliguri" class="hero-slide-img">
        </div>
    </div>
    ...
    <div class="hero-slider-content">
        <div class="container">
            ...
            <p class="location-hero-subtitle">Dive into the world of pure joy and laughter at Jus Jumpin. With more than 15 thrilling gaming activities for kids, soft playzone, an arcade games zone, and a large range of delicious food, a memorable day out is guaranteed with the best kids playzone in Siliguri.</p>
        </div>
    </div>
...
<section class="location-section conclusion-section">
    <div class="container">
        ...
        <p class="conclusion-text"><strong>Jus Jumpin | Siliguri (City Centre)</strong> isn't just another trampoline park — it's an <strong>experience built for adults</strong> who want to jump higher, laugh harder, and rediscover the joy of play.</p>
