...
<section class="location-section experience-section">
    <div class="container">
        ...
        <p class="section-intro">Jus Jumpin at Junction Mall features <strong>an infinity trampoline, foam pits, colorful ball pit, wall climbing, obstacle zone, and a dedicated kids' play zone.</strong>
</p>
...
<section class="location-section activities-section">
    <div class="container">
        ...
        <p class="section-intro">Beyond India's premier trampoline park, experience mind-bending soft play zone for kids, fun merry-go-round, and 15+ interactive gaming activities curated just for you.</p>
        <!-- Toggle Switch -->
