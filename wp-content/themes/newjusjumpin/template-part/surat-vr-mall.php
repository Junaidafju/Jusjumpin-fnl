...
<section class="location-hero-slider">
    <div class="hero-slider-wrapper">
        <div class="hero-slide active">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/surat_vr_mall_1.webp'); ?>" alt="Jus Jumpin Kolkata ABC Square" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/surat_vr_mall_2.webp'); ?>" alt="Adult Trampoline Park Kolkata" class="hero-slide-img">
        </div>
        <div class="hero-slide">
...
Jus Jumpin at VR Mall offers a unique kids' playzone experience, featuring thrilling wall-to-wall trampolines for kids, exciting wave slides, spiral slides, adventure obstacle games for children, and an interactive soft play zone. With international safety and hygiene standards, parents can sit back and relax, while the kids enjoy to their fullest.
            ...
            <div class="content-right">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/surat_vr_mall_body.svg'); ?>" alt="Jus Jumpin Surat VR Mall" class="building-image">
