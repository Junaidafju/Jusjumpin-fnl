...
$image_url = get_template_directory_uri() . '/assets/img/surat_vr_mall_1.webp';
...
$latitude = "21.15785";
$longitude = "72.76618";
$has_map = "https://maps.app.goo.gl/XEDcGyXtUQUFnQ3s7";
$price_range = "₹₹";
...
<section class="location-hero-slider">
    <div class="hero-slider-wrapper">
        <div class="hero-slide active">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/surat_vr_mall_1.webp'); ?>" alt="Kids play area in Surat VR" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/surat_vr_mall_2.webp'); ?>" alt="Kids play area in Surat" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC3.jpg'); ?>" alt="Kids play zone in Surat" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC4.jpg'); ?>" alt="Kids trampoline park in Surat VR Mall" class="hero-slide-img">
        </div>
    </div>
    ...
    <div class="container">
        <div class="content-with-image">
            <div class="content-left">
                ...
                <p class="section-text">Welcome to <strong>Jus Jumpin, VR MALL - Surat,</strong> a wholesome playzone adventure park in Surat, designed specifically for the enjoyment of kids aged between 6 months to 12 years. A perfect destination to let your child's imagination flow without any restrictions. Packed with trampoline, wave slide, tunnels, hanging bridge, wall climber, and soft play area, Jus Jumpin acts as the most exciting children's adventure park in India.</p>
...
Jus Jumpin at VR Mall offers a unique kids' playzone experience, featuring thrilling wall-to-wall trampolines for kids, exciting wave slides, spiral slides, adventure obstacle games for children, and an interactive soft play zone. With international safety and hygiene standards, parents can sit back and relax, while the kids enjoy to their fullest.
</p>
            </div>
            <div class="content-right">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/surat_vr_mall_body.svg'); ?>" alt="Kids play area in Surat VR Mall" class="building-image">
             <div class="image-overlay">
                    <h2 class="building-name">Surat VR Mall</h2>
                </div>
            </div>
        </div>
    </div>
...
<div class="experience-grid">
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Kids-activity-highlights.webp'); ?>" alt="Kids play activities in Surat VR Mall" loading="lazy">
                </div>
                <h3 class="card-title gradient-text"><i class="fas fa-book"></i> Creative & Educational Activities</h3>
            </div>
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Age-specific-activities-highlights.webp'); ?>" alt="Age specific kids play zone in surat" loading="lazy">
                </div>
                <h3 class="card-title gradient-text"><i class="fas fa-child"></i> Age Specific Kids Play Zones</h3>
            </div>
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/FamilyKolkataABC.jpg'); ?>" alt="Kids birthday celebration venue in Surat" loading="lazy">
                </div>
        ...
        <div class="activities-content kids-activities active" data-category="kids">
            <div class="activities-grid">
                ...
                <div class="activity-card glass-card" data-activity-name="Wave Slide">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Wave-slide-activity.webp'); ?>" alt="Kids play zone in Surat" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Sand Pit">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/kids_playing_sandpit_activity.webp'); ?>" alt="Toddler play area in Surat" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Soft Play Area">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/kids_playing_softplay_activity.webp'); ?>" alt="Kids soft play area in Surat" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Pathways">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/pathway_activity.webp'); ?>" alt="kids play area in Surat VR mall" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Doll House">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/kids_playing_dollhouse_activities.webp'); ?>" alt="Doll house for kids play surat" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Tunnel Slide">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/tunnel_slide_Activity.webp'); ?>" alt="Kids play zone in surat" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Merry Go Round">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/indian_kids_merry_go_round_activity.webp'); ?>" alt="Kids play area in surat VR mall" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Zebra Swing">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/zebra_swing_activity.webp'); ?>" alt="Children's amusement park in Surat" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Foam Pit">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/foam_pit_activity2.webp'); ?>" alt="Kids play area surat VR" loading="lazy">
                    </div>
                    <div class="activity-info">
                        <h4 class="activity-title">Foam Pit</h4>
                ...
                <div class="activity-card glass-card" data-activity-name="Ball Pool">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/ball_pool_activities.webp'); ?>" alt="Toddler play area in surat VR" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Interactive Ball Pool">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Interactive_ball_pool_activity.webp'); ?>" alt="Interactive ball pool for kids play surat" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Obstacle Zone">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Obstacle_zone_activity.webp'); ?>" alt="Kids game zone surat" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Pin Wall">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Pin_wall_activity.webp'); ?>" alt="Kids gaming zone surat" loading="lazy">
                    </div>
                    <div class="activity-info">
                        <h4 class="activity-title">Pin Wall</h4>
                ...
                <div class="activity-card glass-card" data-activity-name="Horn Slide">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/horn_slide_activity.webp'); ?>" alt="Kids play area in surat VR" loading="lazy">
                    </div>
                    <div class="activity-info">
...
<section class="location-section map-section">
    <div class="container">
        <h2 class="section-heading"><span class="emoji-icon"><i class="fas fa-map-marker-alt"></i></span> Location: Jus Jumpin VR Mall Surat</h2>
        
        <div class="address-card glass-card">
            <div class="address-content">
                <p class="address-main"><strong>Address:</strong></p>
                <p>3RD FLOOR, VR Mall, JUS JUMPIN, shop no. 303b and 304,<br>
                Dumas Rd, Magdalla, Surat, Gujarat 395007.<br><strong>Call Us:</strong> (+91)98000 05721</p>
                <p class="landmarks"><strong>Landmarks:</strong> Near Dumas Rd, Magdalla (VR MALL)</p>
            </div>
        </div>
        
        <div class="map-container">
            <iframe
                src="https://maps.google.com/maps?q=jus+jumpin+3RD+FLOOR%2C+VR+Mall%2C+JUS+JUMPIN%2C+shop+no.+303b+and+304%2C+Dumas+Rd%2C+Magdalla%2C+Surat%2C+Gujarat+395007&t=&z=13&ie=UTF8&iwloc=&output=embed"
                width="100%"
                height="450"
                ...
                title="Jus Jumpin VR Mall Surat Location">
            </iframe>
        </div>
        
        <div class="map-button-wrapper">
            <a href="https://maps.app.goo.gl/XEDcGyXtUQUFnQ3s7" target="_blank" rel="noopener noreferrer" class="visit-us-button">
...
<section class="location-section conclusion-section">
    <div class="container">
        <h2 class="section-heading white-text"><span class="emoji-icon"><i class="fas fa-brain"></i></span> Why Jus Jumpin Surat?</h2>
