...
$image_url = get_template_directory_uri() . '/assets/img/season_mall_pune2.webp';
...
$latitude = "18.51351";
$longitude = "73.93175";
$has_map = "https://maps.app.goo.gl/AWDnBoBeJAY3dDsCf";
$price_range = "₹₹";
...
<section class="location-hero-slider">
    <div class="hero-slider-wrapper">
        <div class="hero-slide active">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/season_mall_pune2.webp'); ?>" alt="Indoor play area for all age group in Pune" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/season_mall_pune1.webp'); ?>" alt="Trampoline park for adults in Pune" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC3.jpg'); ?>" alt="Indoor fun activities in Pune" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC4.jpg'); ?>" alt="Adults trampoline park in Pune" class="hero-slide-img">
        </div>
    </div>
        ...
        <div class="content-with-image">
            ...
            <div class="content-right">
             ...
             <div class="image-overlay">
                    <h2 class="building-name">Pune Seasons Mall</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="experience-grid">
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KittyKolkataABC.jpg'); ?>" alt="Group party venue in Pune" loading="lazy">
                </div>
                <h3 class="card-title gradient-text"><i class="fas fa-birthday-cake"></i> Amazing Kitty Parties</h3>
            </div>
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/CorporateKolkataABC.jpg'); ?>" alt="Corporate team building activities in Pune" loading="lazy">
                </div>
                <h3 class="card-title gradient-text"><i class="fas fa-building"></i> Corporate Team-Building Events</h3>
            </div>
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/FamilyKolkataABC.jpg'); ?>" alt="Family birthday celebrations in Pune" loading="lazy">
                </div>
                <h3 class="card-title gradient-text"><i class="fas fa-users"></i> Perfect Family Celebrations</h3>
            </div>
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/FitnessKolkataABC.jpg'); ?>" alt="Group Fitness activities in Pune" loading="lazy">
                </div>
...
<section class="location-section activities-section">
    <div class="container">
        ...
        <p class="section-intro">Beyond India's premier trampoline park, experience an adrenaline-filled sky stepper, merry-go-round, colourful slides, and 15+ interactive gaming activities curated just for you.</p>
        <!-- Toggle Switch -->
            ...
            <div class="activities-grid">
                ...
                <div class="activity-card glass-card" data-activity-name="Infinity Trampoline">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Infinity_trampoline_activity.webp?v1'); ?>" alt="Infinity trampoline park in Pune" loading="lazy">
                    </div>
                ...
                <div class="activity-card glass-card" data-activity-name="Donut Slide">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/donut_slide_activity.webp?v1'); ?>" alt="Kids play area in Pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Foam Pit">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/foam_pit_activity.webp?v1'); ?>" alt="Kids play zone in Pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Hanging Bridge">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/hangging_bridge_activity.webp?v1'); ?>" alt="Indoor play area for adults in Pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Zorb Ball">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Zorb_ball_activity.webp?v1'); ?>" alt="Zorb Ball seasons mall pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Bar Dodger">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Bar_dodger_activity.webp?v1'); ?>" alt="Indoor play area for adults in Pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Sky Steeper">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/sky_stepper_activity.webp?v1'); ?>" alt="Indoor play area for adults in Pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Wall Climbing">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Wall_climb_activity.webp?v1'); ?>" alt="Kids play zone in Pune seasons mall" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Magnetic Wall">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Magnet_wall_activity.webp?v1'); ?>" alt="Kids play zone in Pune seasons mall" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Bridge War">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC3.jpg?v1'); ?>" alt="Adults indoor play activity in pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Ninja Activities">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Ninja_Activities_abc.jpg?v1'); ?>" alt="Kids play area in Pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Pin Wall">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Pin_wall_abc.webp?v1'); ?>" alt="Pin wall kids play activity in Pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Basketball Area">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Basketball-area-activity.webp?v1'); ?>" alt="Indoor kids play area in pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Basketball Area">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Net_climb_activity.webp?v1'); ?>" alt="Indoor kids play area in pune" loading="lazy">
                    </div>
                    <div class="activity-info">
        ...
        <div class="activities-content kids-activities" data-category="kids">
            <div class="activities-grid">
                ...
                <div class="activity-card glass-card" data-activity-name="MerryGo Round">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/indian_kids_merry_go_round_activity.webp?v1'); ?>" alt="Indoor kids play area in pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Wave Slide">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Wave-slide-activity.webp?v1'); ?>" alt="Children's amusement park in Pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Swing">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Swing_activity.webp?v1'); ?>" alt="Toddler play zone in Pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Sand Pit">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/kids_playing_sandpit_activity.webp?v1'); ?>" alt="Toddler play zone in Pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Ball Pool">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/ball_pool_activities.webp?v1'); ?>" alt="Kids play area in Pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Tunnels">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Tunnel_activities.webp?v1'); ?>" alt="Kids play zone in Pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Toddler play area">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Toddler_play_activity.webp?v1'); ?>" alt="Kids play zone in Pune" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Soft play area">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Soft_play_activity.webp?v1'); ?>" alt="Soft play area for kids in Pune" loading="lazy">
                    </div>
                    <div class="activity-info">
...
<section class="location-section map-section">
    <div class="container">
        <h2 class="section-heading"><span class="emoji-icon"><i class="fas fa-map-marker-alt"></i></span> Location: Jus Jumpin Season Mall Pune</h2>
        
        <div class="address-card glass-card">
            <div class="address-content">
                <p class="address-main"><strong>Address:</strong></p>
                <p>2nd Floor, Unit No S4, SEASONS MALL,<br>
                Magarpatta, Hadapsar, Pune, Maharashtra 411013<br><strong>Call Us:</strong> (+91)98742 06206</p>
                <p class="landmarks"><strong>Landmarks:</strong> Near Magarpatta, Hadapsar, Pune</p>
            </div>
        </div>
        
        <div class="map-container">
            <iframe
                src="https://maps.google.com/maps?q=Jus+Jumpin%2C+2nd+Floor%2C+Unit+No+S4%2C+SEASONS+MALL%2C+Magarpatta%2C+Hadapsar%2C+Pune%2C+Maharashtra+411013&t=&z=13&ie=UTF8&iwloc=&output=embed"
                width="100%"
                height="450"
                ...
                title="Jus Jumpin Season Mall Pune">
            </iframe>
        </div>
        
        <div class="map-button-wrapper">
            <a href="https://share.google/AWDnBoBeJAY3dDsCf" target="_blank" rel="noopener noreferrer" class="visit-us-button">
                <i class="fas fa-map-marked-alt"></i> Visit Us
            </a>
            <a href="https://reviewthis.biz/seasonsmall" target="_blank" rel="noopener noreferrer" class="visit-us-button">
...
<section class="location-section conclusion-section">
    <div class="container">
        <h2 class="section-heading white-text"><span class="emoji-icon"><i class="fas fa-brain"></i></span> Why Jus Jumpin Season Mall Pune?</h2>
        ...
        <p class="conclusion-text"><strong>Jus Jumpin | Seasons Mall (Pune)</strong>  isn't just another trampoline park — it's an experience built for everyone who wants to jump higher, laugh harder, and rediscover the joy of play.</p>
