...
$image_url = get_template_directory_uri() . '/assets/img/Noida_gip_mall-1.webp';

// Schema specific variables
$alternate_name = "Jus Jumpin\' Adult Trampoline Park and Kids Play Zone";
...
$latitude = "28.56846";
$longitude = "77.32422";
$has_map = "https://maps.app.goo.gl/yJ6h1K14P8qC5n7z8";
$price_range = "₹₹";
    ...
    <div class="hero-slider-content">
        <div class="container">
            <h1 class="location-hero-title">
                ...
                Jus Jumpin<br>GIP Mall - Noida

            </h1>
            <p class="location-hero-subtitle">Hop in to experience the best adult trampoline park in Noida. With more than 15 different activities for kids and adults, a day out to remember for a lifetime is guaranteed.</p>
        </div>
    </div>
    ...
    <div class="container">
        <div class="content-with-image">
            <div class="content-left">
                ...
                <p class="section-text">Welcome to <strong>Jus Jumpin, GIP Mall, Noida.</strong> Jump in for an electrifying experience for kids and adults. At our venue, get access to India's finest trampoline Park for adults, alongside a sparkling kids play zone that complies with international safety & hygiene standards. At our facility, we offer several colourful slides, an obstacle zone, foam pits, a hanging bridge, and more than 15 interactive playing activities for people of all ages.</p>
                <p class="section-text">Our carefully crafted play area is designed to act as a perfect melting pot where families come together, have fun together, and curate memories that last for a lifetime. At Jus Jumpin, we believe that age shouldn’t limit you from having fun. Visit our facility at Noida GIP Mall and give your inner child a jump start again.</p>
                <p class="section-text">At <strong>Jus Jumpin,</strong> Our electrifying trampoline park for adults and with a custom-built playzone for kids, promotes fitness and fun. Hazard-proof and hygienic environment, thoroughly supervised by proficient staff, ensuring worry-free entertainment for friends and families. Customised birthday party and corporate event packages with personalised decorations, exciting party games, and a multi-cuisine menu to make your party talk of the town.
                </p>
            </div>
            <div class="content-right">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Noida_gip_mall-body.webp'); ?>" alt="Noida GIP Mall" class="building-image">
             <div class="image-overlay">
                    <h2 class="building-name">Noida GIP Mall</h2>
                </div>
            </div>
        </div>
    </div>
...
<section class="location-section experience-section">
    <div class="container">
        ...
        <p class="section-intro">Jus Jumpin at GIP Mall features an infinity trampoline, sand pit, foam pit, wall climbing, tunnel slide, and a dedicated kids' play zone.</p>
        ...
        <p class="section-footer-text">Dedicated party area perfect for <strong>hosting amazing birthday parties</strong> and <strong>corporate events </strong>in Noida. The venue features an <strong>awesome in-house DJ</strong> and a <strong>designated cafe with beverages.</strong></p>
    </div>
</section>
...
<section class="location-section activities-section">
    <div class="container">
        ...
        <p class="section-intro">Beyond India's premier trampoline park, experience an interactive obstacle zone, a dedicated soft play zone for kids, colourful slides, and 15+ interactive gaming activities curated just for you.</p>
        <!-- Toggle Switch -->
...
<section class="location-section map-section">
    <div class="container">
        <h2 class="section-heading"><span class="emoji-icon"><i class="fas fa-map-marker-alt"></i></span> Location: Jus Jumpin GIP Mall, Noida</h2>
        
        <div class="address-card glass-card">
            <div class="address-content">
                <p class="address-main"><strong>Address:</strong></p>
                <p>Shop No. 300B , 3rd Floor, The Great India Place Mall,<br>
                Plot A1, opposite Food Court, Sector 38, Noida, Uttar Pradesh 201303.<br><strong>Call Us:</strong> (+91)98301 15533</p>
                <p class="landmarks"><strong>Landmarks:</strong>  Sector 38, Noida</p>
            </div>
        </div>
        
        <div class="map-container">
            <iframe
                src="https://maps.google.com/maps?q=Jus+Jumpin+Shop+No.+300B+%2C+3rd+Floor%2C+The+Great+India+Place+Mall+%2C+Plot+A1%2C+opposite+Food+Court%2C+Sector+38%2C+Noida%2C+Uttar+Pradesh+201303&t=&z=13&ie=UTF8&iwloc=&output=embed"
                width="100%"
                height="450"
                ...
                title="Jus Jumpin GIP Mall Noida">
            </iframe>
        </div>
        
        <div class="map-button-wrapper">
            <a href="https://share.google/bRxsaDuyLI6E3zqLx" target="_blank" rel="noopener noreferrer" class="visit-us-button">
                <i class="fas fa-map-marked-alt"></i> Visit Us
            </a>
            <a href="https://reviewthis.biz/gipmall" target="_blank" rel="noopener noreferrer" class="visit-us-button">
...
<section class="location-section conclusion-section">
    <div class="container">
        <h2 class="section-heading white-text"><span class="emoji-icon"><i class="fas fa-brain"></i></span> Why Jus Jumpin GIP Mall?</h2>
        ...
        <p class="conclusion-text"><strong>Jus Jumpin | GIP Mall (Noida)</strong> isn't just another trampoline park — it's an <strong>experience built for adults</strong> who want to jump higher, laugh harder, and rediscover the joy of play.</p>
