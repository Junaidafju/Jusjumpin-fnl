...
<section class="location-section experience-section">
    <div class="container">
        ...
        <p class="section-intro">Jus Jumpin at Royal Meenakshi Mall features <strong>an infinity trampoline, foam pits, thrilling arcade, wall climbing, basketball zone, and a dedicated kids' play zone.</strong>
</p>
         ...
         <div class="activities-content kids-activities active" data-category="kids">
            <div class="activities-grid">
                ...
                <div class="activity-card glass-card" data-activity-name="Cow Game">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/cow_game_activity.webp'); ?>" alt="Cow Game at Jus Jumpin Avani Mall" loading="lazy">
                    </div>
                    <div class="activity-info">
