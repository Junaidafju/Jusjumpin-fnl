<?php
/**
 * Template: Bengaluru - Meenakshi Mall
 * Modern location page with hero slider and glassmorphism design
 */

// Page specific variables
$title = "Bengaluru - Royal Meenakshi Mall | Jus Jumpin";
$state = "Karnataka";
$city = "Bengaluru";
...
$image_url = get_template_directory_uri() . '/assets/img/Meenakshi_Mall1.webp';
...
$latitude = "12.87568";
$longitude = "77.59554";
$has_map = "https://maps.app.goo.gl/3rNYK919wWQrwopU6";
$price_range = "₹₹";
...
<section class="location-hero-slider">
    <div class="hero-slider-wrapper">
        <div class="hero-slide active">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Meenakshi_Mall1.webp'); ?>" alt="Kids play zone Bangalore" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Meenakshi-mall-2.webp'); ?>" alt="Kids trampoline park in Bangalore" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC3.jpg'); ?>" alt="Kids play area in bangalore" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC4.jpg'); ?>" alt="Trampoline park for kids in Bangalore" class="hero-slide-img">
        </div>
    </div>
    ...
    <div class="container">
        <div class="content-with-image">
            <div class="content-left">
                ...
                <p class="section-text">Time to jump into the most exciting trampoline park for kids in Bengaluru at<strong> Jus Jumpin - Royal Meenakshi Mall.</strong> Thoughtfully designed to provide a safe space for kids to jump and slide without fear and explore new ideas, Jus Jumpin serves as an ideal destination for a perfect family hangout spot. Stacked with 15+ gaming activities, including special attractions like wall to wall trampoline park, hanging bridge, obstacle course and dedicated soft play zone for tiny jumpers, Jus Jumpin lets the kids' imagination run wild.                </p>
                ...
                <p class="section-text">Our Kids play zone Royal Meenakshi Mall provides a safe, yet action-packed fun experience to all the little jumpers with exciting activities like an exciting trampoline park, wall climb, colourful slides, and obstacle courses. Thoughtfully designed to stimulate physical and mental growth through playing, Jus Jumpin is what modern kids' play zones should look like. With international standards of safety and hygiene, Jus Jumpin prioritizes the child's safety before anything else.</p>
            </div>
            <div class="content-right">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/meenakshi_mall_body.webp'); ?>" alt="Royal Meenakshi Mall" class="building-image">
             <div class="image-overlay">
                    <h2 class="building-name">Royal Meenskshi Mall</h2>
                </div>
            </div>
        </div>
    </div>
...
<section class="location-section experience-section">
    <div class="container">
        ...
        <p class="section-intro">Jus Jumpin at Royal Meenakshi Mall features an infinity trampoline, foam pits, interactive ball pool, wall climbing, horn slide, and a dedicated kids' play zone.</p>
        
<div class="experience-grid">
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Kids-activity-highlights.webp?v1'); ?>" alt="Kids play activities in Bangalore" loading="lazy">
                </div>
                <h3 class="card-title gradient-text"><i class="fas fa-book"></i> Creative & Educational Activities</h3>
            </div>
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Age-specific-activities-highlights.webp?v1'); ?>" alt="Age specific kids play zone in Bangalore Meenakshi Mall" loading="lazy">
                </div>
                <h3 class="card-title gradient-text"><i class="fas fa-child"></i> Age Specific Kids Play Zones</h3>
            </div>
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/FamilyKolkataABC.jpg'); ?>" alt="Kids birthday party venue in Bangalore" loading="lazy">
                </div>
         ...
         <div class="activities-content kids-activities active" data-category="kids">
            <div class="activities-grid">
                ...
                <div class="activity-card glass-card" data-activity-name="Wave Slide">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Wave-slide-activity.webp?v1'); ?>" alt="Wave Slide At Jus Jumpin banaglore" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Sand Pit">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/kids_playing_sandpit_activity.webp?v1'); ?>" alt="Toddler Play zone in Bangalore Meenakshi Mall" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Soft Play Area">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/kids_playing_softplay_activity.webp?v1'); ?>" alt="Best kids play zone in Bangalore" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Pathways">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/pathway_activity.webp?v1'); ?>" alt="Pathways for kids in Bangalore" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Doll House">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/kids_playing_dollhouse_activities.webp?v1'); ?>" alt="Doll house for kids in Bangalore Meenakshi Mall" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Tunnel Slide">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/tunnel_slide_Activity.webp?v1'); ?>" alt="Tunnel slide for kids " loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Merry Go Round">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/indian_kids_merry_go_round_activity.webp?v1'); ?>" alt="Merry go round for kids bangalore" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Zebra Swing">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/zebra_swing_activity.webp?v1'); ?>" alt="Zebra swing Meenakshi Mall" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Foam Pit">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/foam_pit_activity2.webp?v1'); ?>" alt="Kids play area Bangalore" loading="lazy">
                    </div>
                    <div class="activity-info">
                        <h4 class="activity-title">Foam Pit</h4>
                ...
                <div class="activity-card glass-card" data-activity-name="Horn Slide">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/horn_slide_activity.webp?v1'); ?>" alt="Horn Slide in Banaglore" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Ball Pool">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/ball_pool_activities.webp?v1'); ?>" alt="Toddler play are bangalore" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Interactive Ball Pool">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Interactive_ball_pool_activity.webp?v1'); ?>" alt="Best kids playzone Bangalore" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Obstacle Zone">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Obstacle_zone_activity.webp?v1'); ?>" alt="Top Kids play area Bangalore" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Donut Slide">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/donut_slide_activity.webp?v1'); ?>" alt="donut slide for kids in bangalore" loading="lazy">
                    </div>
                    <div class="activity-info">
                        <h4 class="activity-title">Donut Slide</h4>
                ...
                <div class="activity-card glass-card" data-activity-name="Cow Game">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/cow_game_activity.webp?v1'); ?>" alt="Cow game for kids bangalore" loading="lazy">
                    </div>
                    <div class="activity-info">
                        <h4 class="activity-title">Cow Game</h4>
                        <p class="activity-desc">Test your aim and coordination in the Cow Game — hit the targets and see who scores the most moos!</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="location-section map-section">
    <div class="container">
        <h2 class="section-heading"><span class="emoji-icon"><i class="fas fa-map-marker-alt"></i></span> Location: Jus Jumpin Meenakshi Mall, Bengaluru</h2>
        
        <div class="address-card glass-card">
            <div class="address-content">
                <p class="address-main"><strong>Address:</strong></p>
                <p>2nd Floor, Unit No. S013A, Royal Meenakshi Mall,<br>
                JUS JUMPIN, Bannerghatta Rd, Hulimavu, Bengaluru, Karnataka 560076.<br><strong>Call Us:</strong> (+91)98301 15533</p>
                <p class="landmarks"><strong>Landmarks:</strong> Bannerghatta Road, Hulimavu</p>
            </div>
        </div>
        
        <div class="map-container">
            <iframe
                src="https://maps.google.com/maps?q=Jus+Jumpin+2nd+Floor%2C+Unit+No.+S013A%2C+Royal+Meenakshi+Mall%2C+JUS+JUMPIN%2C+Bannerghatta+Rd%2C+Hulimavu%2C+Bengaluru%2C+Karnataka+560076&t=&z=13&ie=UTF8&iwloc=&output=embed"
                width="100%"
                height="450"
                ...
                title="Jus Jumpin Meenakshi Mall, Bengaluru">
            </iframe>
        </div>
        
        <div class="map-button-wrapper">
            <a href="https://share.google/Vrs7PBdaEBhqV0O2b" target="_blank" rel="noopener noreferrer" class="visit-us-button">
                <i class="fas fa-map-marked-alt"></i> Visit Us
            </a>
            <a href="https://reviewthis.biz/meenakshimall" target="_blank" rel="noopener noreferrer" class="visit-us-button">
...
<section class="location-section conclusion-section">
    <div class="container">
        <h2 class="section-heading white-text"><span class="emoji-icon"><i class="fas fa-brain"></i></span> Why Jus Jumpin Meenakshi Mall?</h2>
