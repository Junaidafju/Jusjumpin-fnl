...
<section class="location-hero-slider">
    <div class="hero-slider-wrapper">
        <div class="hero-slide active">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Meenakshi_Mall1.webp'); ?>" alt="Jus Jumpin Meenakshi Mall " class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Meenakshi-mall-2.webp'); ?>" alt="Adult Trampoline Park Bengaluru" class="hero-slide-img">
        </div>
        <div class="hero-slide">
         ...
         <div class="activities-content kids-activities active" data-category="kids">
            <div class="activities-grid">
                ...
                <div class="activity-card glass-card" data-activity-name="Cow Game">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/cow_game_activity.webp?v1'); ?>" alt="Cow Game at Jus Jumpin Avani Mall" loading="lazy">
                    </div>
                    <div class="activity-info">
