...
<section class="location-hero-slider">
    <div class="hero-slider-wrapper">
        ...
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC2.jpg'); ?>" alt="Adult Trampoline Park Kolkata" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC3.jpg'); ?>" alt="Kolkata City Centre 2 Activities" class="hero-slide-img">
        </div>
        <div class="hero-slide">
        ...
        <div class="activities-content kids-activities active" data-category="kids">
            <div class="activities-grid">
                ...
                <div class="activity-card glass-card" data-activity-name="Tunnel">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Tunnel_activities.webp?v1'); ?>" alt="Tunnel At Jus Jumpin Avani Mall" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Military Training Pathway">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Military Training Pathway_activities.webp?v1'); ?>" alt="Military Training Pathway At Jus Jumpin Avani Mall" loading="lazy">
                    </div>
                    <div class="activity-info">
