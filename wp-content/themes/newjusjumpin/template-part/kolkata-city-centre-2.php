        ...
        <div class="activities-content kids-activities active" data-category="kids">
            <div class="activities-grid">
                ...
                <div class="activity-card glass-card" data-activity-name="Tunnel">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Tunnel_activities.webp'); ?>" alt="Tunnel At Jus Jumpin Avani Mall" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Military Training Pathway">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Military Training Pathway_activities.webp'); ?>" alt="Military Training Pathway At Jus Jumpin Avani Mall" loading="lazy">
                    </div>
                    <div class="activity-info">
