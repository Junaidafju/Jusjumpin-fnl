<?php
/**
 * Template: Kolkata - City Centre 2
 * Modern location page with hero slider and glassmorphism design
 */

// Page specific variables
$title = "Kolkata - City Centre 2 | Jus Jumpin";
$state = "West Bengal";
$city = "Kolkata";
...
$image_url = get_template_directory_uri() . '/assets/img/jus-jumpin-City-center-2.webp';

// Schema specific variables
$alternate_name = "Jus\' Jumpin Kid\'s Play Zone";
...
$latitude = "22.62278";
$longitude = "88.45028";
$has_map = "https://maps.app.goo.gl/6bmCKUYomarcyZnB9";
$price_range = "₹₹";
...
<section class="location-hero-slider">
    <div class="hero-slider-wrapper">
        <div class="hero-slide active">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/jus-jumpin-City-center-2.webp'); ?>" alt="Jus Jumpin Kolkata City Centre 2" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC2.jpg'); ?>" alt="Kids play zone in Newtown" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC3.jpg'); ?>" alt="Kids play zone in Newtown" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC4.jpg'); ?>" alt="Trampoline for Kids" class="hero-slide-img">
        </div>
    </div>
    ...
    <div class="hero-slider-content">
        <div class="container">
            <h1 class="location-hero-title">
                ...
                Jus Jumpin<br>City Center 2 - Kolkata

            </h1>
            <p class="location-hero-subtitle">Dive into the world of pure joy and laughter at Jus Jumpin. With more than 15 thrilling gaming activities for kids, soft playzone, and a large range of delicious food, a memorable day out is guaranteed with the finest Children’s amusement park in Kolkata.</p>
        </div>
    </div>
    ...
    <div class="container">
        <div class="content-with-image">
            <div class="content-left">
                ...
                <p class="section-text">Welcome to <strong>Jus Jumpin, City Centre 2,</strong> a wholesome playzone adventure park designed specifically for the enjoyment of kids aged between 6 months to 12 years. A perfect destination to let your child's imagination flow without any restrictions. Packed with trampoline, wave slide, tunnels, hanging bridge, wall climber, and soft play area, Jus Jumpin acts as the most exciting children's adventure park in India.</p>
                <p class="section-text">With a keen eye for cleanliness and spotless safety standards, Jus Jumpin ensures your child's safety alongside a joyous experience. Our team of highly proficient staff always supervise the kids' playzone to secure the environment from safety hazards.</p>
                <p class="section-text">Our bright venue at City Centre 2, Kolkata, offers an exclusive kids' play experience, curated with action-packed wall-to-wall trampoline for tiny jumpers, thrilling spiral and wave slides, fun-packed obstacle courses, and an activity-driven soft play area. With strict safety and hygiene standards in place at Jus Jumpin, the parents can entrust us with their child's safety and relax. Our enchanting venue also specialises in hosting amazing birthday parties and social events with customised themes, party games, lip-smacking food, and exciting birthday party activities.</p>
            </div>
            <div class="content-right">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/jus-jumpin-City-center-body.webp'); ?>" alt="City Centre 2" class="building-image">
             <div class="image-overlay">
                    <h2 class="building-name">City Centre 2</h2>
                </div>
            </div>
        </div>
    </div>
...
<div class="experience-grid">
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Kids-activity-highlights.webp?v1'); ?>" alt="Kid friendly Activities in Newtown" loading="lazy">
                </div>
                <h3 class="card-title gradient-text"><i class="fas fa-book"></i> Creative & Educational Activities</h3>
            </div>
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Age-specific-activities-highlights.webp?v1'); ?>" alt="Kids play zone city center 2" loading="lazy">
                </div>
                <h3 class="card-title gradient-text"><i class="fas fa-child"></i> Age Specific Kids Play Zones</h3>
            </div>
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/FamilyKolkataABC.jpg'); ?>" alt="Birthday Celebrations in city center 2" loading="lazy">
                </div>
        ...
        <div class="activities-content kids-activities active" data-category="kids">
            <div class="activities-grid">
                ...
                <div class="activity-card glass-card" data-activity-name="Wave Slide">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Wave-slide-activity.webp?v1'); ?>" alt="Wave Slide At Jus Jumpin city center 2" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Sand Pit">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/kids_playing_sandpit_activity.webp?v1'); ?>" alt="Sand Pit At Jus Jumpin City Center 2" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Soft Play Area">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/kids_playing_softplay_activity.webp?v1'); ?>" alt="Soft Play Area for kids" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Pathways">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/pathway_activity.webp?v1'); ?>" alt="Pathways Area At Jus Jumpin" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Doll House">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/kids_playing_dollhouse_activities.webp?v1'); ?>" alt="Children's amusement park in city center 2" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Tunnel Slide">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/tunnel_slide_Activity.webp?v1'); ?>" alt="Tunnel Slide Area At Jus Jumpin Rajarhat" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Merry Go Round">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/indian_kids_merry_go_round_activity.webp?v1'); ?>" alt="Merry Go Round At Jus Jumpin City center 2" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Zebra Swing">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/zebra_swing_activity.webp?v1'); ?>" alt="Zebra Swing At Jus Jumpin" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Foam Pit">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/foam_pit_activity2.webp?v1'); ?>" alt="Foam Pit Area At Jus Jumpin City center 2" loading="lazy">
                    </div>
                    <div class="activity-info">
                        <h4 class="activity-title">Foam Pit</h4>
                ...
                <div class="activity-card glass-card" data-activity-name="Wall Climbing">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/climbing_wall_activity.webp?v1'); ?>" alt="Wall Climbing At Jus Jumpin Rajarhat" loading="lazy">
                    </div>
                    <div class="activity-info">
                        <h4 class="activity-title">Wall Climbing</h4>
                ...
                <div class="activity-card glass-card" data-activity-name="Ball Pit">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/ball_pit_Activity.webp?v1'); ?>" alt="Ball Pit At Jus Jumpin Rajarhat" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <!-- Kids Activity 12 -->
                <div class="activity-card glass-card" data-activity-name="Tunnel">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Tunnel_activities.webp?v1'); ?>" alt="Tunnel at Jus Jumpin City center 2" loading="lazy">
                    </div>
                    <div class="activity-info">
                        <h4 class="activity-title">Tunnel</h4>
                        <p class="activity-desc">Crawl through our exciting adventure tunnel — a fun-filled journey of curiosity, laughter, and little surprises around every corner!.</p>
                    </div>
                </div>
                <!-- Kids Activity 13 -->
                <div class="activity-card glass-card" data-activity-name="Military Training Pathway">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Military Training Pathway_activities.webp?v1'); ?>" alt="Military traininig pathway at Jus Jumpin" loading="lazy">
                    </div>
                    <div class="activity-info">
                        <h4 class="activity-title">Military Training Pathway</h4>
                        <p class="activity-desc">Take on the ultimate mini-challenge! Crawl, jump, and balance your way through our Military Training Pathway — where fun meets fearless adventure.</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="location-section map-section">
    <div class="container">
        <h2 class="section-heading"><span class="emoji-icon"><i class="fas fa-map-marker-alt"></i></span> Location: Jus Jumpin – City Centre 2</h2>
        
        <div class="address-card glass-card">
            <div class="address-content">
                <p class="address-main"><strong>Address:</strong></p>
                <p>SHOP NO M-2ND FLOOR, City Centre Mall, 202, Rajarhat Main Rd, Action Area II,<br>
                Action Area IID, Newtown, New Town, West Bengal 700161<br><strong>Call Us:</strong> (+91)90070 86212</p>
                <p class="landmarks"><strong>Landmarks:</strong> Located in City Centre 2, Rajarhat</p>
            </div>
        </div>
        
        <div class="map-container">
            <iframe
                src="https://maps.google.com/maps?q=Jus%27+Jumpin+Kid%27s+Play+Zone+city+center+2&t=&z=16&ie=UTF8&iwloc=&output=embed"
                width="100%"
                height="450"
                ...
                title="Jus Jumpin Kolkata City Centre 2 Location">
            </iframe>
        </div>
        
        <div class="map-button-wrapper">
            <a href="https://maps.app.goo.gl/hHP7NBzbtQzpudmXA" target="_blank" rel="noopener noreferrer" class="visit-us-button">
                <i class="fas fa-map-marked-alt"></i> Visit Us
            </a>
            <a href="https://reviewthis.biz/citycentre2" target="_blank" rel="noopener noreferrer" class="visit-us-button">
...
<section class="location-section conclusion-section">
    <div class="container">
        ...
        <p class="conclusion-text"><strong>Jus Jumpin | Kolkata (City Centre 2)</strong> isn't just another trampoline park — it's an experience built for kids who want to jump higher, laugh harder, and rediscover the joy of play.</p>
