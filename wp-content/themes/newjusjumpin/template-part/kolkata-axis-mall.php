...
<section class="location-hero-slider">
    <div class="hero-slider-wrapper">
        <div class="hero-slide active">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Axis-mall.webp'); ?>" alt="Jus Jumpin Kolkata Axis Mall" class="hero-slide-img">
        </div>
    ...
    <div class="container">
        <div class="content-with-image">
            ...
            <div class="content-right">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/AXIS-MALL-BODY.WEBP'); ?>" alt="Axis Mall" class="building-image">
...
<div class="experience-grid">
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="https://www.jusjumpin.com/wp-content/uploads/2025/12/compressed_AXIS-MALL.webp'); ?>" alt="Creative & Educational Activities" loading="lazy">
                </div>
