<?php
/**
 * Template: Nagpur - VR Mall
 * Modern location page with hero slider and glassmorphism design
 */

// Page specific variables
$title = "Nagpur - VR Mall | Jus Jumpin";
$state = "Maharashtra";
$city = "Nagpur";
$slug = "nagpur-vr-mall";
$address = "Jus Jumpin, VR, Rambagh Layout, Untkhana, Nagpur, Maharashtra 440003";
...
$image_url = get_template_directory_uri() . '/assets/img/Nagpur_vr_mall_1.webp';

// Schema specific variables
$alternate_name = "Jus Jumpin| Kid\'s Play and Activity Zone";
...
$latitude = "21.13330";
$longitude = "79.09639";
$has_map = "https://maps.app.goo.gl/ZxK2AePGdV8XLo9u7";
$price_range = "₹₹";
...
<section class="location-hero-slider">
    <div class="hero-slider-wrapper">
        <div class="hero-slide active">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Nagpur_vr_mall_1.webp'); ?>" alt="Jus Jumpin Nagpur VR Mall" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Nagpur_vr_mall_2.webp'); ?>" alt="Kids aplay area and Birthday PartyVenue In Nagpur" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC3.jpg'); ?>" alt="Kids play zone Nagpur" class="hero-slide-img">
        </div>
        <div class="hero-slide">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/KolkataABC4.jpg'); ?>" alt="Trampoline Park Fun Nagpur" class="hero-slide-img">
        </div>
    </div>
    ...
    <div class="hero-slider-content">
        <div class="container">
            <h1 class="location-hero-title">
                ...
                Jus Jumpin<br>VR Mall - Nagpur
            </h1>
            <p class="location-hero-subtitle">Dive into the world of pure joy and laughter at Jus Jumpin. With more than 15 thrilling gaming activities for kids, soft playzone, and a large range of delicious food, a memorable day out is guaranteed with the best Kids’ Playzone Adventure Park in Nagpur.</p>
        </div>
    </div>
    ...
    <div class="container">
        <div class="content-with-image">
            <div class="content-left">
                ...
                <p class="section-text">Jump into<strong> Jus Jumpin,</strong>  the best children's amusement park in Nagpur. What sets Jus Jumpin apart from ordinary kids' play zones is our approach towards providing an amazing experience where playing meets learning. Our meticulously designed kids' theme park offers an action-packed atmosphere where children can run, jump and laugh freely, and the parents can entrust us with our global safety and hygiene standards in place. Our wall-to-wall trampoline park, Merry-go-Round, Horn slide, interactive ball pool, Doll house & Obstacle courses encourage children to interact positively and develop crucial motor skills.</p>
                <p class="section-text">Alongside our action-packed trampoline park for kids, our kids' play area in Nagpur is stacked with amazing kid-friendly activities. Our facility in Nagpur facilitates interactive activities like Merry-go-round, Tunnel slide, Pin wall, Foam pit, Ball pool, Obstacle zone, wall climbing, and many more. With a dedicated soft play area, Jus Jumpin Kids play zone is perfect for toddlers and small kids aged between 6 months and 12 years.</p>
                <p class="section-text">Our vibrant venue also serves as the ideal kids' birthday party venue in Nagpur. At our dedicated birthday party area, you can host an exciting birthday party for your beloved child with personalized decorations, exciting party games for the kids, exclusive access to our play zone, and, of course, a large range of delectable food. Visit Jus Jumpin today, and watch your little one jump into new heights.</p>
            </div>
            <div class="content-right">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/VR_mall_body.webp'); ?>" alt="VR Mall Nagpur" class="building-image">
             <div class="image-overlay">
                    <h2 class="building-name">VR Mall Nagpur </h2>
                </div>
            </div>
        </div>
    </div>
...
<section class="location-section experience-section">
    <div class="container">
        ...
        <p class="section-intro">Jus Jumpin at Nagpur VR Mall features an infinity trampoline, ball pool, pin wall, wall climbing, horn slide, and a dedicated kids' play zone.</p>
...
<div class="experience-grid">
            ...
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Age-specific-activities-highlights.webp?v1'); ?>" alt="Age Specific Play Zones in Nagpur" loading="lazy">
                </div>
                <h3 class="card-title gradient-text"><i class="fas fa-child"></i> Age Specific Kids Play Zones</h3>
            </div>
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/FamilyKolkataABC.jpg?v1'); ?>" alt="Birthday Celebrations" loading="lazy">
                </div>
                <h3 class="card-title gradient-text"><i class="fas fa-birthday-cake"></i> Perfect Birthday Celebrations</h3>
            </div>
            <div class="experience-card glass-card">
                <div class="card-image">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Resting-zone-highlights.webp?v1'); ?>" alt="Dedicated Resting Zone For Parents" loading="lazy">
                </div>
...
<section class="location-section activities-section">
    <div class="container">
        ...
        <p class="section-intro">Beyond India's premier trampoline park, experience an interactive soft play area, merry-go-round, colourful slides, and 15+ interactive gaming activities curated just for you</p>
        <!-- Toggle Switch -->
        ...
        <div class="activities-content kids-activities active" data-category="kids">
            <div class="activities-grid">
                ...
                <div class="activity-card glass-card" data-activity-name="Wave Slide">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Wave-slide-activity.webp?v1'); ?>" alt="Wave slide Nagpur VR" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Sand Pit">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/kids_playing_sandpit_activity.webp?v1'); ?>" alt="Sand Pit At Jus Jumpin Nagpur" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Soft Play Area">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/kids_playing_softplay_activity.webp?v1'); ?>" alt="Kids Soft Play Area Nagpur" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Pathways">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/pathway_activity.webp?v1'); ?>" alt="Pathways Area At Jus Jumpin Nagpur" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Doll House">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/kids_playing_dollhouse_activities.webp?v1'); ?>" alt="Doll House Area At Jus Jumpin Nagpur" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Tunnel Slide">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/tunnel_slide_Activity.webp?v1'); ?>" alt="Tunnel Slide Area At Jus Jumpin Nagpur" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Zebra Swing">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/zebra_swing_activity.webp?v1'); ?>" alt="Zebra Swing At Jus Jumpin Nagpur" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Foam Pit">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/foam_pit_activity2.webp?v1'); ?>" alt="Soft play activities in Nagpur" loading="lazy">
                    </div>
                    <div class="activity-info">
                        <h4 class="activity-title">Foam Pit</h4>
                ...
                <div class="activity-card glass-card" data-activity-name="Ball Pool">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/ball_pool_activities.webp?v1'); ?>" alt="Ball Pool Area At Jus Jumpin Nagpur" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Interactive Ball Pool">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Interactive_ball_pool_activity.webp?v1'); ?>" alt="Interactive Ball Pool At Jus Jumpin Nagpur VR" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Obstacle Zone">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Obstacle_zone_activity.webp?v1'); ?>" alt="School dayout activity In Nagpur" loading="lazy">
                    </div>
                    <div class="activity-info">
                ...
                <div class="activity-card glass-card" data-activity-name="Pin Wall">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/Pin_wall_activity.webp?v1'); ?>" alt="Kids friendly activities Nagpur" loading="lazy">
                    </div>
                    <div class="activity-info">
                        <h4 class="activity-title">Pin Wall</h4>
                        <p class="activity-desc">Let creativity pop on the Pin Wall — where kids press, shape, and create fun 3D impressions with colorful pins!</p>
                    </div>
                </div>
                <!--Kids Activity 14 -->
                <div class="activity-card glass-card" data-activity-name="Horn Slide">
                    <div class="activity-image">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/horn_slide_activity.webp?v1'); ?>" alt="Children's Amusement Park Nagpur" loading="lazy">
                    </div>
                    <div class="activity-info">
...
<section class="location-section map-section">
    <div class="container">
        <h2 class="section-heading"><span class="emoji-icon"><i class="fas fa-map-marker-alt"></i></span> Location: Jus Jumpin VR Mall Nagpur</h2>
        
        <div class="address-card glass-card">
            <div class="address-content">
                <p class="address-main"><strong>Address:</strong></p>
                <p>Jus Jumpin, VR, Rambagh Layouts<br>
                Untkhana, Nagpur, Maharashtra 440003.<br><strong>Call Us:</strong> (+91)98368 88333</p>
                <p class="landmarks"><strong>Landmarks:</strong> 2nd Floor, VR Mall, Near Rambagh Layouts, Untkhana, Nagpur</p>
            </div>
        </div>
        
        <div class="map-container">
            <iframe
                src="https://maps.google.com/maps?q=Jus+Jumpin%2C+VR%2C+Rambagh+Layout%2C+Untkhana%2C+Nagpur%2C+Maharashtra+440003&t=&z=13&ie=UTF8&iwloc=&output=embed"
                width="100%"
                height="450"
                ...
                title="Jus Jumpin Nagpur VR Mall">
            </iframe>
        </div>
        
        <div class="map-button-wrapper">
            <a href="https://share.google/nx3aXcA0PMJPTuDWb" target="_blank" rel="noopener noreferrer" class="visit-us-button">
                <i class="fas fa-map-marked-alt"></i> Visit Us
            </a>
            <a href="https://reviewthis.biz/vrnagpur" target="_blank" rel="noopener noreferrer" class="visit-us-button">
...
<section class="location-section conclusion-section">
    <div class="container">
        <h2 class="section-heading white-text"><span class="emoji-icon"><i class="fas fa-brain"></i></span> Why Jus Jumpin Nagpur?</h2>
        ...
        <p class="conclusion-text"><strong>Jus Jumpin | VR MALL (Nagpur)</strong> isn't just another trampoline park — it's an experience built for kids who want to jump higher, laugh harder, and rediscover the joy of play.</p>
